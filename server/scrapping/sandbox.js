...
async function dedicatedScrape() {
  urls = [];
  try {
...
async function montlimartScrape(
  eshop = "https://www.montlimart.com/polos-t-shirts.html"
) {
  try {
    console.log(`🕵️‍♀️  browsing ${eshop} source`);
...
async function adresseScrape(
  eshop = "https://adresse.paris/583-manteaux-et-blousons"
) {
  try {
    console.log(`🕵️‍♀️  browsing ${eshop} source`);
